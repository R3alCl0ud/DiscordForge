...
class commandHandler {
    ...
    handleMessage() {
        return function (message) {
            ...
            if (this.client.options.selfBot && author.id !== this.client.user.id) return;
            if (author.bot) return;
            if (this.client.options.perGuild && channel.type === "text") return this.perGuild(message, author, channel, guild);
